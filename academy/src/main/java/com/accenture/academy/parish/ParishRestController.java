...
public class ParishRestController {
    ...
    @PatchMapping("/{parishId}/cementaryPresent")
    void setCementaryPresent(@RequestBody CementaryPresentDto cementaryPresentDto, @PathVariable Long parishId){
        parishService.setCementaryPresent(cementaryPresentDto, parishId);
    }
