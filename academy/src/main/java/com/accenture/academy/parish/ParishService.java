...
public class ParishService {
    ...
    void setCementaryPresent(CementaryPresentDto cementaryPresentDto, Long parishId){
        ParishDao parishDao = getById(parishId);
        parishDao.setIsCementaryPresent(cementaryPresentDto.getIsCementaryPresent());
        parishRepository.save(parishDao);
    }
